...
<head>
    ...
    <title>Dashboard - BKK Dumai</title>
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo py-5">
                    <a href="{{route('home')}}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold text-primary">BKK Dumai
                        </span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="{{route('bank_data')}}" class="menu-link">
                            <i class="menu-icon tf-icons ti ti-layout-grid"></i>
                            <div data-i18n="Email">Bank Data</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="eCommerce">Form</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{route('cop')}}" class="menu-link">
                                    <div data-i18n="Dashboard">COP</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="app-ecommerce-dashboard.html" class="menu-link">
                                    <div data-i18n="Dashboard">SSCEC</div>
                                </a>
                            </li><li class="menu-item">
                                <a href="app-ecommerce-dashboard.html" class="menu-link">
                                    <div data-i18n="Dashboard">P3K</div>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-fluid navbar navbar-expand-xl navbar-detached align-items-center bg-primary"
                    id="layout-navbar">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <div class="d-grid gap-2 px-2 pt-2 pb-1">
                                                <button type="submit" class="btn btn-sm btn-danger"> <i
                                                        class="ti ti-logout ms-2 me-2 ti-14px"></i> Logout</button>
                                    </li>
                                    </form>
                                </ul>
                            </li>
    ...
    <script>
        ...
        imageUrl: assetsPath + '/img/illustrations/boy-app-academy.png',
        imageWidth: 400,
